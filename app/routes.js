export var lambRoutes = [
    ...
    group2: [
        ...
        { route: 'flower32', image: 'flower32.png', name: 'flower32', moduleId: './app/flower32/flower32', nav: true, title: '32. Generates blinking stereo pairs, effect of rotating 3D wire sculpture cube with dodecahedron outside'},
    ]
}
;